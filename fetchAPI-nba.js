...
// und speichert das Ergebnis im gewünschten Format in data-nba.json.
...
try {
	...
	console.log(`Saved ${data.length} records to data-nba.json`);
} catch (err) {
	console.error("fetchAPI-nba.js error:", err);
}
